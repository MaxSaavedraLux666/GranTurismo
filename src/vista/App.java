...
public class App {
    ...
    public static void main(String[] args) {
        ...
        tour1 = new Tour("Machu Picchu", itinerario, 14.5f, 8, "CD23", "LIBRE", new Date(2021, 21, 11));
        tourTamaño.agregar(tour1);

        itinerario = new Itinerario(" 11:20 ", " Paseo en bus por la ciudadela");
        itinerarios.agregar(itinerario);

        tour1 = new Tour("Ciudadela", itinerario, 13.5f, 4, "CH56", "OCUPADO", new Date(2021, 22, 11));
        tourTamaño.agregar(tour1);

        itinerario = new Itinerario(" 12:20 ", "Ceremonia del Inti Raymi");
        itinerarios.agregar(itinerario);

        tour1 = new Tour("IntiRaymi", itinerario, 12.5f, 5, "CF23", "LIBRE", new Date(2021, 23, 11));
        tourTamaño.agregar(tour1);
